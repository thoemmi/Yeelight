...
name: my_bulb";
            ...
            Assert.AreEqual(DeviceCapabilities.GetProperties | DeviceCapabilities.SetDefault | DeviceCapabilities.SetPower | DeviceCapabilities.Toggle | DeviceCapabilities.SetBrightness | DeviceCapabilities.StartColorFlow | DeviceCapabilities.StopColorFlow | DeviceCapabilities.SetScene | DeviceCapabilities.StartTimer | DeviceCapabilities.GetTimer | DeviceCapabilities.DeleteTimer | DeviceCapabilities.SetColorTemperature | DeviceCapabilities.SetRGB, device.Capabilities);
